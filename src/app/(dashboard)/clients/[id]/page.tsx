            ...
            <Card className="rounded-xl p-5 shadow-sm lg:col-span-2">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <Field label="Last contact">
                  ...
                  />
                  {/*
                    Below the field, not beside it — it acts ON the date rather
                    than sitting alongside as a peer control.

                    When the date is already today there's nothing to do, so
                    this reads as a confirmation rather than a greyed-out
                  ...
                  {isToday(client.last_contact) ? (
                    ...
                    <div className="mt-1.5 flex items-center gap-2">
                      <button
                        type="button"
                        onClick={() => {
                          updateClient({ last_contact: format(new Date(), "yyyy-MM-dd") });
                          toast.success("Marked as contacted today");
                        }}
                        className="flex items-center gap-1.5 rounded-md border border-border px-2 py-1 text-[11px] text-foreground-secondary transition-colors hover:border-primary/40 hover:bg-primary/10 hover:text-foreground"
                      >
