        ...
        {adding && (
          <form onSubmit={addMember} className="flex flex-col gap-4">
            ...
            <div>
              ...
              {/* Generated by default. Supabase's leaked-password check is a
                  Pro feature, but it only helps when a human picks the
                  password — a random 20-character one can't be in a breach
                  list at all, so this is the stronger answer and it's free. */}
              <div className="flex items-center gap-2">
                <Input
                  required
                  type="text"
                ...
                <Button
                  ...
                  variant="secondary"
                  className="shrink-0"
                  onClick={() => setAdding({ ...adding, password: generatePassword() })}
                >
                  Generate
                </Button>
              </div>
              <p className="mt-1 text-[11px] text-muted-2">
                They can change it in Settings once they&apos;re in.
              </p>
            </div>
            <div>
